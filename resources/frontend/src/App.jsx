      ...
      <Box sx={{ px: 2.5, pb: 2, pt: 1 }}>
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, mb: 1.5 }}>
          ...
          <Box sx={{ overflow: 'hidden' }}>
            ...
            <Typography
              variant="caption"
              sx={{ color: alpha('#fff', 0.5), textTransform: 'uppercase', letterSpacing: '0.08em', fontSize: '0.65rem' }}
            >
              {roleName}
            </Typography>
          </Box>
          ...
          return (
            <ListItemButton
              ...
              sx={{
                ...
                backgroundColor: isActive ? alpha(theme.palette.secondary.main, 0.15) : 'transparent',
                '&:hover': {
            ...
            >
              <ListItemIcon
                sx={{
                  color: isActive ? theme.palette.secondary.main : alpha('#fff', 0.4),
                  minWidth: 36,
                }}
              >
                {item.icon}
              ...
              <ListItemText
                primary={item.label}
                slotProps={{
                  primary: { sx: { fontSize: '0.85rem', fontWeight: isActive ? 700 : 500 } },
                }}
              />
              {isActive && (
                <Box
...
export default function App() {
  ...
  if (!userRole || !['administrator', 'reseller_manager', 'bd_agent'].includes(userRole)) {
    return (
        ...
        <Box sx={{ display: 'flex', flex: 1 }}>
          ...
          >
            ...
            <Box sx={{ display: 'flex', justifyContent: 'flex-end', p: 1 }}>
              <IconButton onClick={() => setMobileOpen(false)} sx={{ color: alpha('#fff', 0.6) }}>
                <CloseIcon />
              </IconButton>
            </Box>
